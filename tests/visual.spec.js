...
// Visual tests to compare against the existing site
// These tests will help identify what needs to be implemented for visual parity

test.describe("Visual Regression Tests", () => {
  test.beforeEach(async ({ page }) => {
    // Wait for the Yew app to load
