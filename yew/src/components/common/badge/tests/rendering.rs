...
#[test]
fn test_badge_renders_basic_badge() {
...
#[test]
fn test_badge_renders_with_custom_variant() {
    let props = BadgeProps {
...
#[test]
fn test_badge_renders_all_variants() {
...
#[test]
fn test_badge_renders_with_custom_size() {
    let props = BadgeProps {
...
#[test]
fn test_badge_renders_all_sizes() {
    let size_tests = vec![
        (BadgeSize::Small, "px-2", "py-0.5", "text-xs"),
        (BadgeSize::Medium, "px-2.5", "py-1", "text-sm"),
        (BadgeSize::Large, "px-3", "py-1.5", "text-base"),
...
#[test]
fn test_badge_renders_rounded_variant() {
    let props = BadgeProps {
        rounded: true,
        children: Children::new(vec![html! { <span>{"Rounded Badge"}</span> }]),
        ..Default::default()
    };
...
#[test]
fn test_badge_renders_non_rounded_variant() {
    let props = BadgeProps {
        rounded: false,
        children: Children::new(vec![html! { <span>{"Non-Rounded Badge"}</span> }]),
        ..Default::default()
    };
...
#[test]
fn test_badge_renders_with_custom_classes() {
    let props = BadgeProps {
        class: Classes::from("custom-class"),
        children: Children::new(vec![html! { <span>{"Custom Badge"}</span> }]),
        ..Default::default()
    };
...
#[test]
fn test_badge_renders_complex_children() {
    let props = BadgeProps {
        children: Children::new(vec![
            html! { <span>{"Complex"}</span> },
...
#[test]
fn test_badge_renders_empty_children() {
    let props = BadgeProps {
        children: Children::new(vec![]),
        ..Default::default()
    };
...
#[test]
fn test_badge_renders_complex_combination() {
    let props = BadgeProps {
        variant: BadgeVariant::Success,
        size: BadgeSize::Large,
        rounded: true,
        class: Classes::from("custom-class"),
        children: Children::new(vec![html! { <span>{"Complex"}</span> }]),
    };
...
#[test]
fn test_badge_renders_all_base_classes() {
...
#[test]
fn test_badge_renders_variant_and_size_combination() {
    let props = BadgeProps {
    ...
    assert!(classes.contains("bg-blue-100"));
    assert!(classes.contains("text-blue-800"));
...
#[test]
fn test_badge_renders_with_multiple_custom_classes() {
    let props = BadgeProps {
        class: Classes::from("class1 class2 class3"),
        children: Children::new(vec![html! { <span>{"Multi-Class Badge"}</span> }]),
        ..Default::default()
    };
