...
#[test]
fn test_badge_props_default_values() {
...
#[test]
fn test_badge_props_custom_values() {
...
#[test]
fn test_badge_variant_enum_values() {
    let variants = vec![
...
#[test]
fn test_badge_size_enum_values() {
...
#[test]
fn test_badge_props_partial_eq() {
...
#[test]
fn test_badge_props_rounded_states() {
...
#[test]
fn test_badge_props_with_custom_classes() {
    let props = BadgeProps {
...
#[test]
fn test_badge_props_with_children() {
...
#[test]
fn test_badge_props_all_combinations() {
    let variants = vec![
        BadgeVariant::Default,
        BadgeVariant::Success,
        BadgeVariant::Danger,
...
#[test]
fn test_badge_props_empty_children() {
    let props = BadgeProps {
...
#[test]
fn test_badge_props_complex_children() {
    let children = Children::new(vec![
